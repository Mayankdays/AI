...
def ai(messages, chapter):
    ...
    prompt_template = """Answer the question as precise as possible, but still in a fun manner to keep the reader engaged using the provided context. If the answer is
                        not contained in the context, say "answer not available in context".If asked for diffficult questions, make questions with diffcult ratings. If asked for a formula,
